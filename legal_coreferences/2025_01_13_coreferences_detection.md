...
### Average of `without examples` results:

| Model           |   Samples |   Mistakes |   Precision |   Recall |   Total Time (s) |   Avg Time (s) |
|:----------------|----------:|-----------:|------------:|---------:|-----------------:|---------------:|
| gemma3:12b      |       100 |      12.67 |      0.8475 |   0.93   |            19.1  |           0.19 |
| ministral-3:14b |       100 |      15.83 |      0.791  |   0.9567 |            12.42 |           0.12 |
| llama3.2:3b     |       100 |      28.33 |      0.6873 |   0.8867 |             8.74 |           0.09 |